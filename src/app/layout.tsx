...
export const metadata: Metadata = {
  ...
  description:
    '4 недели системной работы с причинами хронической усталости: нервная система, ЖКТ, углеводный обмен и система питания для молодости. От автора «Энергии за 7 дней».',
};
